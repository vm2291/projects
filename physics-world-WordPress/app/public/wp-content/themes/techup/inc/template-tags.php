...
if ( ! function_exists( 'techup_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function techup_posted_on() {
...
if ( ! function_exists( 'techup_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function techup_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html( '%s', 'post author', 'techup' ),
...
if ( ! function_exists( 'techup_post_comments' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function techup_post_comments() {
...
if ( ! function_exists( 'techup_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function techup_entry_footer() {
