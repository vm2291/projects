	...
	var WprLibraryTmpls = {
		...
		renderPopup: function( previewIframe ) {
			...
			if ( previewIframe.find( '.wpr-tplib-popup' ).length == 0 ) {
				var headerNavigation  = '<li data-tab="pages" class="wpr-tplib-active-tab">Pages</li>';
		...
		renderPopupContent: function( previewIframe, tab ) {
			...
			// Render Preview
				...
				previewIframe.find( '.wpr-tplib-sidebar input' ).on( 'keyup', function() {
					...
					searchTimeout = setTimeout(function() {
						...
						if ( '' !== val ) {
							...
							previewIframe.find('.wpr-tplib-template-wrap').hide();
							previewIframe.find('.wpr-tplib-template-wrap[data-title*="'+ val +'"]'+ priceAttr ).show();
						} else {
				...
				previewIframe.find( '.wpr-tplib-insert-template' ).on( 'click', function() {
					...
					template = ('blocks' === activeTab || 'popups' === activeTab) ? module +'/'+ template : template;
